...
| `/mnt/work/Projects/.ai/` | Agent OS (skills, standards, guides) — sibling thin-client; no local `.ai/` |
...
| Scope check | `bash /mnt/work/Projects/.ai/scripts/touch-scope-verify.sh` (when Agent OS scripts present) |
| Blast radius | `bash /mnt/work/Projects/.ai/scripts/blast-radius-check.sh` (when Agent OS scripts present) |
