...
**Agnostic** process (skills, standards, concepts, guides) lives in the sibling Agent OS at **`/mnt/work/Projects/.ai/`** (thin-client — no local `.ai/` in this repo).
...
Operator entry: `/mnt/work/Projects/.ai/START_HERE.md`
...
```bash
bash /mnt/work/Projects/.ai/templates/bootstrap.sh
```

Or invoke `@project-bootstrap init`.

Foundation docs **01–04** are created by `@plan-foundation greenfield` (templates under `/mnt/work/Projects/.ai/templates/work/plans/foundation/`).
